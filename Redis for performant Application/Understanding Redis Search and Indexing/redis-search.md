...
Redis Search is a Redis module that enables <font color="#4bacc6">full-text search</font> and <font color="#c0504d">secondary indexing</font> on your Redis data. It works with structured data stored in **Hash** and **JSON** formats.
